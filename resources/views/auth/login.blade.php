                ...
                <div class="m-login__signin">
                    ...
                    <form class="m-login__form m-form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group m-form__group">
                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }} m-input"
                                   type="text" placeholder="Tên tài khoản" name="name" autocomplete="off">
                            @if ($errors->has('name'))
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('name') }}</strong>
                                </span>
                    ...
                    <form class="m-login__form m-form" action="">
                        ...
                        <div class="m-login__form-action">
                            ...
                            <button id="m_login_forget_password_cancel"
                                    class="btn btn-outline-focus m-btn m-btn--pill m-btn--custom m-login__btn">Thoát
                            </button>
                        </div>
                    </form>
                </div>
